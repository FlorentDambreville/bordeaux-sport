...
actual fun Query.addSnapshotListener_(
    metadataChanges: com.applantic.firestore.MetadataChanges?,
...
internal fun com.applantic.firestore.MetadataChanges.toJvm():MetadataChanges =
    if (this == com.applantic.firestore.MetadataChanges.INCLUDE) {
